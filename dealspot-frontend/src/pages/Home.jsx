...
import { Heart, MapPin, Calendar, Tag, Cpu, Shirt, Home as HomeIcon, Dumbbell, UtensilsCrossed, MoreHorizontal, Search, Clock, AlertTriangle } from 'lucide-react';
          ...
          <div className="flex flex-col sm:flex-row gap-3 max-w-2xl mx-auto">
            ...
            {(categorie || localisation) && (
              <button
                ...
                className="bg-gray-100 text-gray-600 px-6 py-3 rounded-lg hover:bg-gray-200 transition-colors font-medium"
              >
                Réinitialiser
              </button>
            )}
                ...
                {expiringOffers.length > 4 && (
                  <div className="mt-4 text-center">
                    <button
                      ...
                      className="italic underline underline-offset-2 decoration-1 hover:text-red-700 transition-colors"
                    >
